...
ogImage: "https://blog.worqhat.com/og/c6f9c89ea8b506661a0172d7f178fb91.png"
videoUrl: "https://www.youtube.com/watch?v=CEiMy-Kercw"
videoPoster: "https://blog.worqhat.com/og/c6f9c89ea8b506661a0172d7f178fb91.png"
...
1. **Time-Based Runs** – Executes daily at 09:00 with no human intervention.  
2. **Query Data** – Issues a parameterized SQL query against the production sales cluster (yesterday’s transactions).  
3. **Text Gen (Detailed Analysis)** – Converts the result set into a formal executive summary and normalized JSON payload of metrics.  
4. **Create Graphs** – Renders visual assets (bar, line, stacked, dual-axis) directly from the JSON metrics.  
5. **Send Mail** – Distributes the final briefing (summary, KPI table, inline charts, action recommendations) to the leadership alias.  
...
### 5. Send Mail
- **Subject:** `Daily Revenue Briefing — {{yesterday_date}}`  
- **Body Sections:** Executive summary, KPI table, inline charts, “Actions Today” list  
